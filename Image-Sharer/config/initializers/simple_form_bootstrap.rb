...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_input_group, tag: 'div', class: 'form-group', error_class: 'has-danger' do |b|
    ...
    b.wrapper tag: 'div' do |ba|
      ...
      ba.use :hint,  wrap_with: { tag: 'p', class: 'text-help text-muted' }
    end
  end
  ...
  config.wrappers :horizontal_select_date, tag: 'div', class: 'form-group', error_class: 'has-danger' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-control-label'
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group', error_class: 'has-danger' do |b|
    ...
    b.wrapper tag: 'div', class: 'col-sm-offset-3 col-sm-9' do |wr|
      ...
      wr.use :hint,  wrap_with: { tag: 'p', class: 'text-help text-muted' }
    end
  end
